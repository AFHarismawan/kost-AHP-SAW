...
class Home extends CI_Controller {
    ...
    public function tingkat_akurasi() {
        $data['data'] = $this->M_Bobot->getData();
        $data['kriteria'] = $this->M_kriteria->getData();
        $this->load->view('include/header');
        $this->load->view('include/sidebar');
        $this->load->view('tingkat_akurasi', $data);
        $this->load->view('include/footer');
    }

    public function pengujian() {
        $data['data'] = $this->M_nilai_prefensi->getDataCampuran2();
        $this->load->view('include/header');
        $this->load->view('include/sidebar');
    ...
    public function rangking_cowok2() {
        $data = $this->M_nilai_prefensi->getDataCowok2();
        $this->load->view('include/header');
        $this->load->view('include/sidebar');
    ...
    public function rangking_cewek2() {
        $data = $this->M_nilai_prefensi->getDataCewek2();
        $this->load->view('include/header');
        $this->load->view('include/sidebar');
    ...
    public function simpanbobot() {
        ...
        $this->M_Bobot->deleteTable('bobot_prioritas');
    ...
    public function simpanPreferensi() {
        ...
        $this->M_Bobot->deleteTable('nilai_prefensi');
    ...
    public function simpanPreferensi2() {
        $nama = $_POST['nama'];
        $pref = $_POST['data'];
        
        $this->M_Bobot->deleteTable('nilai_prefensi2');
        for ($i = 0; $i < count($nama); $i++) {
            $data = array(
                'id' => $i + 1,
                'nama' => $nama[$i],
                'nilai_preferensi' => $pref[$i]
            );

            $this->M_Bobot->insertData('nilai_prefensi2', $data);
        }
    }
